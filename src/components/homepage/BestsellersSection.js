      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-lg items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
          ...
          <div className="bento-card rounded-2xl p-6 border border-outline-variant/50 flex flex-col items-center gap-4 relative overflow-hidden group">
            <div className="absolute top-4 left-4 bg-tertiary text-on-tertiary font-label-md px-3 py-1 rounded-full text-xs">
              Save 18%
            </div>
            <div className="w-full h-48 flex justify-center items-center py-4">
              <div className="w-32 h-40 bg-surface rounded-md shadow-md border border-outline-variant/30 flex items-center justify-center text-on-surface-variant text-center p-2 relative">
                <Image
                  ...
                  src="/images/homepage/product-1.jpg"
                />
              </div>
            </div>
            ...
            <Button
              variant="outline"
              className="w-full mt-2 bg-transparent border-on-surface text-on-surface font-label-lg py-5 hover:bg-primary-container hover:border-primary-container hover:text-on-surface transition-all flex justify-center items-center gap-2 rounded-none"
            >
            ...
            <div className="w-full h-48 flex justify-center items-center py-4">
              <div className="w-32 h-40 bg-surface rounded-md shadow-md border border-outline-variant/30 flex items-center justify-center text-on-surface-variant text-center p-2 relative">
                <Image
                  alt="Coffee Bag"
                  fill
                  className="object-cover rounded-sm mix-blend-multiply hue-rotate-90"
                  src="/images/homepage/product-2.jpg"
                />
              </div>
            </div>
            <div className="w-full flex flex-col gap-1 text-center">
            ...
            <div className="w-full h-48 flex justify-center items-center py-4">
              <div className="w-32 h-40 bg-surface rounded-md shadow-md border border-outline-variant/30 flex items-center justify-center text-on-surface-variant text-center p-2 relative">
                <Image
                  alt="Coffee Bag"
                  fill
                  className="object-cover rounded-sm mix-blend-multiply hue-rotate-180"
                  src="/images/homepage/product-3.jpg"
                />
              </div>
            </div>
            <div className="w-full flex flex-col gap-1 text-center">
            ...
            <div className="w-full h-48 flex justify-center items-center py-4">
              <div className="w-32 h-40 bg-surface rounded-md shadow-md border border-outline-variant/30 flex items-center justify-center text-on-surface-variant text-center p-2 relative">
                <Image
                  alt="Coffee Bag"
                  fill
                  className="object-cover rounded-sm mix-blend-multiply hue-rotate-[270deg]"
                  src="/images/homepage/product-4.jpg"
                />
              </div>
            </div>
            <div className="w-full flex flex-col gap-1 text-center">
        ...
        <div className="mt-8">
          <Button
            variant="outline"
            className="bg-transparent border-on-surface text-on-surface font-label-lg px-6 py-5 hover:bg-on-surface hover:text-surface transition-colors rounded-none flex items-center gap-2"
          >

    ...
    <footer className="bg-surface-container dark:bg-surface-dim grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop py-xl w-full border-t border-surface-container-high dark:border-surface-container">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex w-full mt-2">
          <input
            className="w-full bg-surface border border-on-surface px-4 py-2 text-on-surface font-body-md outline-none focus:border-primary"
            placeholder="john@example.com"
            type="email"
          />
          <button className="bg-primary-container text-on-surface border border-l-0 border-on-surface px-4 font-label-lg hover:opacity-90 transition-opacity">
            Submit
          </button>
        </div>
        <p className="font-body-md text-on-surface-variant text-sm mt-2">
          Subscribe to receive communication about our latest products, discount
          offerings and stories.
        </p>
      </div>
      ...
      <div className="flex gap-12 md:col-span-2 md:justify-end">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            className="font-body-md text-body-md text-on-surface-variant dark:text-on-surface-variant hover:text-primary transition-colors hover:underline decoration-primary"
            href="#"
          >
            Instagram
          </Link>
